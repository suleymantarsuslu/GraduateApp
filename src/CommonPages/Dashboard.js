            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-md-12">
                        <div className="card">
                            <div className="card-header">
                                <h4 className="card-title" align="center">GRADUATION APPLICATION</h4>
                            </div>
                    ...
                    <div className="col-md-6">
                        <div className="card">
                            <div className="card-header">
                                <h4 className="card-title" align="center">Who Can Apply</h4>
                            </div>
                            <div className="card-body">
                                <p>
                    ...
                    <div className="col-md-6">
                        <div className="card">
                            <div className="card-header">
                                <h4 className="card-title" align="center">How to Apply</h4>
                            </div>
                            <div className="card-body">
                                <p>
                    ...
                    <div className="col-md-6" align="center">
                        <div className="card">
                            <div className="card-body" >
                                <img src= {require("../assets/img/graduate.jpg" )}alt="Avatar" className="avatar" style={{width: "100px", height: "100px"}}/> 
